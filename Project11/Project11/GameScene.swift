...
//  Project11
//
//  Created by Александр Банников on 05.08.2020.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        var upLoc = touch.location(in: self)
        upLoc.y = frame.height
        print(upLoc)
...
//        else if limit == 0 {
//            let ac = UIAlertController(title: "Out of balls", message: nil, preferredStyle: .actionSheet)
